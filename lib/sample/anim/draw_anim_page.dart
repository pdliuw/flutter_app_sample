...
///
/// DrawAnimPage
class DrawAnimPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _DrawAnimState();
  }
}

///
/// _DrawAnimState
class _DrawAnimState extends State<DrawAnimPage> {
...
class DrawCirclePage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _DrawCircleState();
  }
}

class _DrawCircleState extends State<DrawCirclePage> {
  bool run = true;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
...
class DrawMultiPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _DrawMultiState();
  }
}
