...
///
/// AirLicensePage
class AirLicensePage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _AirLicenseState();
  }
}
...
<ul><a href="https://github.com/pdliuw/flutter_app_sample">https://github.com/pdliuw/flutter_app_sample</a></ul>
</ul>
</body>
</html>
''';
...
///
/// _AirLicenseState
class _AirLicenseState extends State<AirLicensePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Builder(builder: (BuildContext context) {
        return WebView(
          initialUrl: 'https://github.com/pdliuw/flutter_app_sample/blob/master/LICENSE',
